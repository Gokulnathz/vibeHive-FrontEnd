...
export const loginUser=(email,password)=>async(dispatch)=>{
    try{
        ...
        const {data}= await axios.post(`${REACT_APP_API_URL}/login`,{email,password},{withCredentials: true},{
            headers:{
...
export const loadUser=()=>async(dispatch)=>{
    try{
        ...
        const {data}= await axios.get(`${REACT_APP_API_URL}/my/profile`,{ withCredentials: true,});
...
export const getFollowingPosts = () => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${REACT_APP_API_URL}/posts`, { withCredentials: true });
...
export const getAllUsers = (name="") => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${REACT_APP_API_URL}/users?name=${name}`, { withCredentials: true });
  ...
  export const getMyPosts = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${REACT_APP_API_URL}/mypost/${id}`, { withCredentials: true });
  ...
  export const logoutUser=()=>async(dispatch)=>{
    try{
        ...
        await axios.get(`${REACT_APP_API_URL}/logout`,{withCredentials: true});
...
export const registerUser=(name,email,password,avatar)=>async(dispatch)=>{
  try{
    ...
    formData.append('avatar', avatar);
      ...
      const {data}= await axios.post(`${REACT_APP_API_URL}/register`,formData,{withCredentials: true},{
          headers:{
...
export const updateProfile=(name,email,avatar)=>async(dispatch)=>{
  try{
    ...
    if (avatar instanceof File) {  // Ensure it's a File object
      ...
      const {data}= await axios.put(`${REACT_APP_API_URL}/update/profile`,formData,{withCredentials: true,
          headers:{
              "Content-Type":"multipart/form-data"
          },
      });
...
export const updatePassword=(oldPassword,newPassword)=>async(dispatch)=>{
  try{
      ...
      const {data}= await axios.put(`${REACT_APP_API_URL}/update/password`,{oldPassword,newPassword},{withCredentials: true,
          headers:{
              "Content-Type":"application/json"
          },
      });
...
export const deleteProfile=()=>async(dispatch)=>{
  try{
      ...
      const {data}= await axios.delete(`${REACT_APP_API_URL}/delete/profile`,{withCredentials: true,
          headers:{
              "Content-Type":"application/json"
          },
      });
...
export const forgotPassword=(email)=>async(dispatch)=>{
  try{
      ...
      const {data}= await axios.post(`${REACT_APP_API_URL}/forgot/password`,{email},{withCredentials: true,
          headers:{
              "Content-Type":"application/json"
          },
      });
...
export const resetPassword=(token,password)=>async(dispatch)=>{
  try{
      ...
      const {data}= await axios.put(`${REACT_APP_API_URL}/password/reset/${token}`,{password},{withCredentials: true,
          headers:{
              "Content-Type":"application/json"
          },
      });
...
export const getUserPosts = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${REACT_APP_API_URL}/userpost/${id}`, { withCredentials: true });
  ...
  export const getUserProfile = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${REACT_APP_API_URL}/user/${id}`, { withCredentials: true });
  ...
  export const followAndUnfollowUser = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${REACT_APP_API_URL}/follow/${id}`, { withCredentials: true });
